...
static final List<BannerModel> banners = [
  BannerModel(targetScreen: TRoutes.order, active: false, imageUrl: TImages.banner1),
  BannerModel(targetScreen: TRoutes.cart, active: true, imageUrl: TImages.banner2),
  BannerModel(targetScreen: TRoutes.favourites, active: true, imageUrl: TImages.banner3),
  BannerModel(targetScreen: TRoutes.search, active: true, imageUrl: TImages.banner4),
  BannerModel(targetScreen: TRoutes.settings, active: true, imageUrl: TImages.banner5),
  BannerModel(targetScreen: TRoutes.userAddress, active: true, imageUrl: TImages.banner6),
  BannerModel(targetScreen: TRoutes.checkout, active: true, imageUrl: TImages.banner7),
  BannerModel(targetScreen: TRoutes.signIn, active: false, imageUrl: TImages.banner8),
];
...
List<ProductModel> generateRandomProducts(int count) {
  ...
  for (int i = 0; i < count; i++) {
    products.add(ProductModel(
      id: "00"+ random1.toString(), // Generate random unique ID (using a library like uuid)
      stock: Random().nextInt(100) + 1, // Random stock between 1 and 100
      price: Random().nextDouble() * 990 + 10, // Random price between $10 and $1000
      title: faker.sport.name(), // Generate random product name
      thumbnail: imageUrls[random-1], // Placeholder image URL
...
static final List<ProductModel> products1 = TDummyData().generateRandomProducts(3);
